...
def main():
    ...
    suffix = ''
    # -------------------------------------------------------------------------
    loss_fn_vgg = lpips.LPIPS(net='vgg', pnet_rand=True, model_path='experiments/pretrained_models/vgg16-397923af.pth').cuda()  # RGB, normalized to [-1,1]
    lpips_all = []
    ...
    for i, img_path in enumerate(img_list):
        ...
        # calculate lpips
        lpips_val = loss_fn_vgg(img_restored.unsqueeze(0).cuda(), img_gt.unsqueeze(0).cuda()).item()
