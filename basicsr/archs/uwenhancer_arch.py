...
from basicsr.archs.uconvnext_arch import UConvNeXt
...
class LightNet(nn.Module):
    ...
    def low_pass_filter(self, images, cutoff_freq=1):  # cutoff_freq=1
...
class UWEnhancer(nn.Module):
    def __init__(self):
        ...
        self.uconvnext = UConvNeXt(in_chans=7, dim=64, res_dim=128)
    ...
    def postprocess_depth(self, depth, depth_min=0.1, depth_gap=7.9): 
